    ...
    <div className={style.contentWrapper}>
      <div className={style.commonBlock}>
        <div className={style.startText}>
          ...
          <p>
            Приложение <strong>RSlang</strong> - отличный способ весело и качественно изучить более 3 тысяч английских слов
            и их употребление в речи!<br/>Изучать английский язык будет интересно как взрослым, так и детям, а приятный дизайн и настраиваемый геймплей с кучей игр не дадут вам заскучать!
          </p>
        </div>
      ...
      <div className={style.largeText}>
          ...
          <ul>
            <li><strong>Методика интервального повторения</strong> - это ключевой элемент приложения, определяющий насколько эффективно вы изучите слова</li>
            <li><strong>Большое количество настроек</strong> - благодаря которым вы можете изменять внешний вид и некоторые детали работы приложения в соответствии с собственными предпочтениями</li>
            <li><strong>Статистика</strong> - вы можете наблюдать статистику изучения слов, как краткосрочную – по результатам каждой тренировки, так и долгосрочную – за весь период обучения.</li>
            <li><strong>Большое колличество игр</strong> - кроме стандартного обучения, можно играть в 6 мини-игр. Это поможет развивать твой английский со всех сторон!</li>
          </ul>
      </div>
      <div className={style.commonBlock}>
      <Slider {...settings}>
        ...
        <div className={style.commonBlock}>
          <div className={style.aboutContainer}>
            ...
            <p> Попадая в приложение тебе необходимо зарегистрироваться или зайти в учетную запись под существующими данными.
                Регистрируясь, помни, что твой email должен быть настоящим, а пароль должен содержать не менее 8 символов, как
                минимум одну прописную букву, одну заглавную букву, одну цифру и один спецсимвол из <i>{'+-_&@$!%*?#.,;:[]{}'}</i>.
            </p>
          </div>
          <div className={style.screenShotContainer}>
            <img src='/images/screenshots/1screen.png'></img>
          </div>
        </div>
        }
        ...
        <div className={style.commonBlock} id='lol'>
          <div className={style.screenShotContainer}>
            <img src='/images/screenshots/3screen.png'></img>
          </div>
          <div className={style.aboutContainer}>
            <h3>Страница обучения</h3>
            <p> На странице обучения вы можете тренировать свой английский вводя нужные слова слова в зависимости от подсказок
        ...
        <div className={style.commonBlock} id='lol'>
          <div className={style.aboutContainer}>
            ...
            <p> На странице статистики есть 3 режима: статистика за сегодня, изученные слова, ежедневные достижения. Вы можете отследить свой прогресс как
              вам угодно, от количества просмотренных карточек, до графиков с прогрессом изучения по каждому дню!
            </p>
          </div>
          <div className={style.screenShotContainer}>
            <img src='/images/screenshots/13screen.png'></img>
          </div>
        </div>
        }
        ...
        <div className={style.commonBlock}>
          <div className={style.screenShotContainer}>
            <img src='/images/screenshots/15screen.png'></img>
          </div>
          <div className={style.aboutContainer}>
            <h3>Страница словаря</h3>
            <p> На странице словарь, можно посмотреть слова собранные по 3 разделам: все изучаемые слова, сложные слова, удаленные слова.
      ...
      {pageDescription === 'mini-games' &&
        <div className={style.commonBlock}>
          <div className={style.aboutContainer}>
            ...
            <li title='Узнать больше' onClick={()=> setPageDescription('challenge')}>Аудио вызов</li>
          ...
          <div className={style.screenShotContainer}>
            <img src='/images/screenshots/4screen.png'></img>
          </div>
        </div>
      }
      {pageDescription === 'puzzle' &&
        <div className={style.commonBlock}>
          <div className={style.screenShotContainer}>
            <img src='/images/screenshots/9screen.png'></img>
          </div>
          <div className={style.aboutContainer}>
            <h3>English Puzzle</h3>
            <p> English-puzzle - мини-игра, цель которой собрать картину , выбирая подсказки, собирая при этом
        ...
        <div className={style.commonBlock}>
          <div className={style.aboutContainer}>
            <h3>Speak It</h3>
            <p> SpeakIt - мини-игра, при помощи которой можно прослушать произношение английских слов и
          ...
          <div className={style.screenShotContainer}>
            <img src='/images/screenshots/10screen.png'></img>
          </div>
        </div>
        }
        ...
        <div className={style.commonBlock}>
          <div className={style.screenShotContainer}>
            <img src='/images/screenshots/6screen.png'></img>
          </div>
          <div className={style.aboutContainer}>
            <h3>Savannah</h3>
            <p> Savannah - мини-игра, где на экран выводиться слова на английском языке. Нужно выбрать перевод слова из
        ...
        <div className={style.commonBlock}>
          <div className={style.aboutContainer}>
            ...
            <p> Audio challenge - мини-игра, где звучит произношение слова на английском языке, нужно выбрать перевод
          ...
          <div className={style.screenShotContainer}>
            <img src='/images/screenshots/8screen.png'></img>
          </div>
        </div>
        }
        ...
        <div className={style.commonBlock}>
          <div className={style.screenShotContainer}>
            <img src='/images/screenshots/7screen.png'></img>
          </div>
          <div className={style.aboutContainer}>
            <h3>Sprint</h3>
            <p> Sprint - мини-игра, где вы видите слово на английском языке и перевод слова, нужно указать принадлежит ли
        ...
        <div className={style.commonBlock}>
          ...
          <div className={style.aboutContainer}>
            <h3>Ассооциации</h3>
            <p> Ассоциации - русская народная игра, где вы видите 10 слов и 10 картинок с описанием к ним.
        ...
        <div className={style.commonBlock}>
          <div className={style.aboutContainer}>
            ...
            <p> Здесь вы можете манипулировать ходом основной и мини-игр, как вам вздумается. Можете добавлять
